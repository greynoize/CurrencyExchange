...
class CurrencyRepositoryImpl(private val currenciesApi: CurrenciesApi) : CurrencyRepository, BaseRepository() {
    override suspend fun getExchangeRates(base: String): Result<ExchangeRateResponseModel> {
        return getApiResult { currenciesApi.getCurrencies(base) }
    }
    ...
    override fun getCurrenciesInfo(): List<CurrencyInfoResponseModel>  {
